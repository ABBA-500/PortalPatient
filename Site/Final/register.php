...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO users(FIO, phone_number, email, pass) values (?,?,?,?);");
    
    if ($stmt->execute([$username, $number, $email, $password])) {
...
<body>
    ...
    <main>
        ...
        <form method="POST">
            <input type="text" name="username" placeholder="ФИО пользователя" required>
